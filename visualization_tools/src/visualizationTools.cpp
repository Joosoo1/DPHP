...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber subOdometry = nh.subscribe<nav_msgs::Odometry> ("/robot/dlio/odom_node/odom", 5, odometryHandler);

  ros::Subscriber subLaserCloud = nh.subscribe<sensor_msgs::PointCloud2> ("/robot/dlio/odom_node/pointcloud/deskewed", 5, laserCloudHandler);
  ...
  printf("\nExploration metrics and vehicle trajectory are saved in 'src/tare/log'.\n\n");
