...
protected:
    void SetUp() override {
        ...
        // 订阅测试结果 (尝试不同的可能话题名称)
        exploration_finish_sub1_ =
            nh_.subscribe("exploration_finish", 1, explorationFinishCallback);
        exploration_finish_sub2_ =
            nh_.subscribe("/explorer/exploration_finish", 1, explorationFinishCallback);
