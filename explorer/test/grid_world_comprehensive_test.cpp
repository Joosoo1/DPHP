...
TEST_F(GridWorldComprehensiveTest, SubdivisionConversionTest) {
    ...
    Eigen::Vector3i sub = grid_world_->GetCellSub(
...
TEST_F(GridWorldComprehensiveTest, NeighborCellTest) {
    ...
    Eigen::Vector3i center_sub = grid_world_->GetCellSub(
        Eigen::Vector3d(robot_position_.x, robot_position_.y, robot_position_.z));
...
TEST_F(GridWorldComprehensiveTest, ExploringCellTest) {
    ...
    int cell_ind2 =
        grid_world_->GetCellInd(robot_position_.x + 6.0, robot_position_.y, robot_position_.z);
...
TEST_F(GridWorldComprehensiveTest, GlobalTSPTest) {
    ...
    exploration_path_ns::ExplorationPath path =
        grid_world_->SolveGlobalTSP(viewpoint_manager, ordered_cell_indices);
...
TEST_F(GridWorldComprehensiveTest, DirectKeyposeGraphConnectionTest) {
    ...
    bool has_connection =
        grid_world_->HasDirectKeyposeGraphConnection(keypose_graph, start_position, goal_position);
