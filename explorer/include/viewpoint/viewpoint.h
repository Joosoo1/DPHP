...
private:
  ...
  bool connected_;
  // Whether this viewpoint has been visited by the robot. If true, its coverage area will not be updated and it will not be selected in the sampling process.
