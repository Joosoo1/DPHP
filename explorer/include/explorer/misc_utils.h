...
namespace misc_utils_ns
{
    ...
    public:
        ...
        ~Timer() = default;
        void Start() { timer_start_ = std::chrono::high_resolution_clock::now(); }
    ...
    public:
        ...
        ~Marker() = default;
        void SetColorRGBA(const std_msgs::ColorRGBA& color) { marker_.color = color; }
        ...
        void SetType(int type) { marker_.type = type; }
        void SetAction(visualization_msgs::Marker::_action_type action) { marker_.action = action; }
        void Publish() { misc_utils_ns::Publish<visualization_msgs::Marker>(marker_pub_, marker_, frame_id_); }
