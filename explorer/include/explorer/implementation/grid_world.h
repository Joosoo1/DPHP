...
namespace grid_world_ns
{
    ...
    // cell组成grid world
    class GridWorld : public grid_world_ns::IGridWorld
    {
    public:
        ...
        void UpdateCellKeyposeGraphNodes(const std::shared_ptr<keypose_graph_ns::KeyposeGraph>& keypose_graph) const;
        ...
        // 获取该cell的状态
        grid_world_ns::CellStatus GetCellStatus(int cell_ind) const;
        // 设置该cell的状态
        void SetCellStatus(int cell_ind, grid_world_ns::CellStatus status) const;
        // 获取该cell的位置
