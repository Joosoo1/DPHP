...
#include "explorer/implementation/lidar_model.h"
...
struct planning_env_ns::PlanningEnvParameters
{
    ...
    class PlanningEnv : public planning_env_ns::IPlanningEnv
{
public:
...
private:
    ...
    std::vector<PlannerCloudType::Ptr> keypose_cloud_stack_;
    std::vector<PlannerCloudType::Ptr> vertical_surface_cloud_stack_;
