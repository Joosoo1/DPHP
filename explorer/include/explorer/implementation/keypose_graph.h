...
public:
    ...
    explicit KeyposeNode(const geometry_msgs::Point& point, int node_ind = 0, int keypose_id = 0,
                         bool is_keypose = true);
    ~KeyposeNode() = default;
    bool IsKeypose() const { return is_keypose_; }
    bool IsConnected() const { return is_connected_; }
    void SetOffsetToKeypose(const geometry_msgs::Point& offset_to_keypose) { offset_to_keypose_ = offset_to_keypose; }
    ...
    class KeyposeGraph : public keypose_graph_ns::IKeyposeGraph
{
private:
...
public:
    ...
    bool InBound(const int index) { return index >= 0 && index < graph_.size(); }
    int GetNodeNum() { return nodes_.size(); }
    ...
    std::vector<int> GetConnectedGraphNodeIndices() { return connected_node_indices_; }
    ...
    void SetAllowVerticalEdge(const bool allow_vertical_edge) { allow_vertical_edge_ = allow_vertical_edge; }
    ...
    double GetShortestPath(const geometry_msgs::Point& start_point, const geometry_msgs::Point& target_point,
                           bool get_path, nav_msgs::Path& path, bool use_connected_nodes = false) const;

    double& SetAddNodeMinDist() { return kAddNodeMinDist; }
    double& SetAddNonKeyposeNodeMinDist() { return kAddNonKeyposeNodeMinDist; }
    double& SetAddEdgeCollisionCheckResolution() { return kAddEdgeCollisionCheckResolution; }
    double& SetAddEdgeCollisionCheckRadius() { return kAddEdgeCollisionCheckRadius; }
    int& SetAddEdgeCollisionCheckPointNumThr() { return kAddEdgeCollisionCheckPointNumThr; }
    double& SetAddEdgeConnectDistThr() { return kAddEdgeConnectDistThr; }
    double& SetAddEdgeToLastKeyposeDistThr() { return kAddEdgeToLastKeyposeDistThr; }
    double& SetAddEdgeVerticalThreshold() { return kAddEdgeVerticalThreshold; }
