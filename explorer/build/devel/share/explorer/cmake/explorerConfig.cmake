...
if("TRUE" STREQUAL "TRUE")
  set(explorer_SOURCE_PREFIX /home/joosoo/dphp_planner/src/DPHP/explorer)
  set(explorer_DEVEL_PREFIX /home/joosoo/dphp_planner/src/DPHP/explorer/build/devel)
  set(explorer_INSTALL_PREFIX "")
  set(explorer_PREFIX ${explorer_DEVEL_PREFIX})
else()
  set(explorer_SOURCE_PREFIX "")
  set(explorer_DEVEL_PREFIX "")
  set(explorer_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/joosoo/dphp_planner/src/DPHP/explorer/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4 " STREQUAL " ")
  set(explorer_INCLUDE_DIRS "")
  set(_include_dirs "/home/joosoo/dphp_planner/src/DPHP/explorer/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'joosoo <joosoo@buct.edu.cn>' and request to fix the problem.")
  endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT explorer_NUM_DUMMY_TARGETS)
      set(explorer_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::explorer::wrapped-linker-option${explorer_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR explorer_NUM_DUMMY_TARGETS "${explorer_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::explorer::wrapped-linker-option${explorer_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND explorer_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/joosoo/dphp_planner/src/DPHP/explorer/build/devel/lib;/opt/ros/noetic/lib)
...
set(depends "roscpp;std_msgs;nav_msgs;geometry_msgs;sensor_msgs;visualization_msgs;tf;tf_conversions;pcl_ros;pcl_conversions;dynamic_reconfigure;cv_bridge")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(explorer_EXPORTED_TARGETS ${${explorer_dep}_EXPORTED_TARGETS})
endforeach()
