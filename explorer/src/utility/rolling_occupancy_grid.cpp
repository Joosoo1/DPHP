...
#include "explorer/utility/rolling_occupancy_grid.h"
...
namespace rolling_occupancy_grid_ns
{
    ...
    void RollingOccupancyGrid::UpdateOccupancyStatus(const pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud) const
    {
        if (!initialized_)
        {
            return;
    ...
    void RollingOccupancyGrid::GetFrontier(const pcl::PointCloud<pcl::PointXYZI>::Ptr& frontier_cloud,
    ...
    void RollingOccupancyGrid::GetVisualizationCloud(const pcl::PointCloud<pcl::PointXYZI>::Ptr& vis_cloud) const
    {
        vis_cloud->clear();
