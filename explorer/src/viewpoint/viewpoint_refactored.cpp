...
ViewPointRefactored::ViewPointRefactored(double x, double y, double z)
  : lidar_model_(x, y, z)
  , in_collision_(false)
...
double ViewPointRefactored::GetX() const {
  return lidar_model_.getPosition().x;
}

double ViewPointRefactored::GetY() const {
  return lidar_model_.getPosition().y;
}

double ViewPointRefactored::GetHeight() const {
...
geometry_msgs::Point ViewPointRefactored::GetPosition() const {
...
void ViewPointRefactored::SetInCollision(bool in_collision) {
  in_collision_ = in_collision;
}

bool ViewPointRefactored::InCollision() const {
  return in_collision_;
}

void ViewPointRefactored::SetInLineOfSight(bool in_line_of_sight) {
  in_line_of_sight_ = in_line_of_sight;
}

bool ViewPointRefactored::InLineOfSight() const {
  return in_line_of_sight_;
}

void ViewPointRefactored::SetInCurrentFrameLineOfSight(bool in_current_frame_line_of_sight) {
  in_current_frame_line_of_sight_ = in_current_frame_line_of_sight;
}

bool ViewPointRefactored::InCurrentFrameLineOfSight() const {
  return in_current_frame_line_of_sight_;
}

void ViewPointRefactored::SetConnected(bool connected) {
  connected_ = connected;
}

bool ViewPointRefactored::Connected() const {
  return connected_;
}

void ViewPointRefactored::SetVisited(bool visited) {
  visited_ = visited;
}

bool ViewPointRefactored::Visited() const {
  return visited_;
}

void ViewPointRefactored::SetSelected(bool selected) {
  selected_ = selected;
}

bool ViewPointRefactored::Selected() const {
  return selected_;
}

void ViewPointRefactored::SetCandidate(bool candidate) {
  is_candidate_ = candidate;
}

bool ViewPointRefactored::IsCandidate() const {
  return is_candidate_;
}

void ViewPointRefactored::SetHasTerrainHeight(bool has_terrain_height) {
  has_terrain_height_ = has_terrain_height;
}

bool ViewPointRefactored::HasTerrainHeight() const {
  return has_terrain_height_;
}

void ViewPointRefactored::SetTerrainHeight(double terrain_height) {
...
double ViewPointRefactored::GetTerrainHeight() const {
...
bool ViewPointRefactored::HasTerrainNeighbor() const {
  return has_terrain_neighbor_;
}

void ViewPointRefactored::SetInExploringCell(bool in_exploring_cell) {
  in_exploring_cell_ = in_exploring_cell;
}

bool ViewPointRefactored::InExploringCell() const {
  return in_exploring_cell_;
}

void ViewPointRefactored::SetCellInd(int cell_ind) {
  if (cell_ind < -1) {
...
int ViewPointRefactored::GetCellInd() const {
  return cell_ind_;
}

int ViewPointRefactored::GetCellIndex() const {
  return cell_ind_;
}
...
void ViewPointRefactored::ResetCoveredPointList() {
  covered_point_list_.clear();
}

void ViewPointRefactored::ResetCoveredFrontierPointList() {
  covered_frontier_point_list_.clear();
}

const std::vector<int>& ViewPointRefactored::GetCoveredPointList() const {
...
void ViewPointRefactored::AddCoveredPoint(int point_idx) {
  if (point_idx < 0) {
...
void ViewPointRefactored::AddCoveredFrontierPoint(int point_idx) {
  if (point_idx < 0) {
...
int ViewPointRefactored::GetCoveredPointNum() const {
  return static_cast<int>(covered_point_list_.size());
}
...
int ViewPointRefactored::GetCollisionFrameCount() const {
  return collision_frame_count_;
}

void ViewPointRefactored::AddCollisionFrame() {
  collision_frame_count_++;
}

void ViewPointRefactored::ResetCollisionFrameCount() {
  collision_frame_count_ = 0;
}
