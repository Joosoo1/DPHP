...
namespace explorer_visualizer_ns
{
    ...
    bool TAREVisualizer::ReadParameters(ros::NodeHandle& nh)
    {
        ...
        kLocalPlanningHorizonMarkerColor.g =
            misc_utils_ns::getParam<double>(nh, "kLocalPlanningHorizonMarkerColorG", 1.0);
        kLocalPlanningHorizonMarkerColor.b =
            misc_utils_ns::getParam<double>(nh, "kLocalPlanningHorizonMarkerColorB", 0.0);
                                                 ...
                                                 const std::vector<int>& ordered_cell_indices) const
    {
        ...
        int cell_num = ordered_cell_indices.size(); // 子空间tsp排序序列
