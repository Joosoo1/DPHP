...
void GraphRefactored::SetNodePosition(int node_index, const Eigen::Vector3d& position) {
...
void GraphRefactored::AddTwoWayEdge(int from_node_index, int to_node_index, double distance) {
  AddOneWayEdge(from_node_index, to_node_index, distance);
  AddOneWayEdge(to_node_index, from_node_index, distance);
}

double GraphRefactored::GetShortestPath(int from_node_index, int to_node_index, bool get_path,
...
bool GraphRefactored::NodeIndexInRange(int node_index) const {
...
double GraphRefactored::AStarSearch(int from_node_index, int to_node_index, bool get_path,
  ...
  std::priority_queue<iPair, std::vector<iPair>, std::greater<iPair>> open_set;
